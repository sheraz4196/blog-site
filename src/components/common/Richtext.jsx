  ...
  const options = useMemo(() => ({
    ...
    renderNode: {
      ...
      [BLOCKS.PARAGRAPH]: (node, children) => {
        ...
        // console.log("containsIframe", containsIframe);
        if (containsIframe) {
        ...
        const paragraphContent = children.reduce((acc, child) => {
          // If the child is a string, split it by `<c>` tags
        ...
        // Map through paragraphContent to apply styles to parts enclosed in <c> tags
